...
function setup() {
  const canvasWidth = windowWidth; // Set the canvas width to 70% of the window width
  const canvasHeight = windowHeight; // Set the canvas height to the window height
